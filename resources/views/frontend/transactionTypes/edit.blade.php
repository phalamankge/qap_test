                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transaction-types.update", [$transactionType->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="credit_account" id="credit_account" value="{{ old('credit_account', $transactionType->credit_account) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="debit_account" id="debit_account" value="{{ old('debit_account', $transactionType->debit_account) }}" required>
