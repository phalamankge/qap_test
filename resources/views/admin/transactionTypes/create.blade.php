    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transaction-types.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credit_account') ? 'is-invalid' : '' }}" type="text" name="credit_account" id="credit_account" value="{{ old('credit_account', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('debit_account') ? 'is-invalid' : '' }}" type="text" name="debit_account" id="debit_account" value="{{ old('debit_account', '') }}" required>
